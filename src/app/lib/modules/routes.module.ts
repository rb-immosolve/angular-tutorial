...
const routes: Routes = [
  {
    path: '', component: HomepageComponent, resolve: { autoLogin: 'userAutologinFn' }, children: [
      {
        path: 'recipe', component: RecipeComponent, resolve: { recipes: 'recipeResolverFn' }, children: [
